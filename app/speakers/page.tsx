  ...
  return (
    <>
      ...
      <LoadingElement delay={0}>
        <main className="flex flex-col overflow-x-hidden mainBackgroundGradient -mb-20">          
        ...
        <main className="flex flex-col overflow-x-hidden justify-center bg-gradient-to-b from-[#6C6BD1] to-white">
