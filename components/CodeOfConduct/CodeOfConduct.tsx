...
const CodeOfConduct: React.FC = () => {
    return (
        <div className="content-container p-8 rounded-lg max-w-3xl mx-auto mt-10">
        <h1 className="text-4xl purpleText font-bold mb-6 text-left">Code of Conduct</h1>
        ...
        <h2 className="text-3xl lightPurpleText font-bold mt-8 mb-4 text-left">The Pledge</h2>
        <p className="textFont mb-4 text-left">
          In the interest of fostering an open and welcoming environment, we pledge to make participation in our project and our community a harassment-free experience for everyone, regardless of age, body size, disability, ethnicity, gender identity and expression, level of experience, nationality, personal appearance, race, religion, or sexual identity and orientation.
        </p>

        <h2 className="text-3xl lightPurpleText font-bold mt-8 mb-4 text-left">The Standards</h2>
        <p className="textFont mb-4 text-left">
        ...
        <ul className="list-disc pl-8 textFont text-left">
          ...
          <li>Using sexualized language or imagery, or unwelcome sexual attention.</li>
        ...
        <h2 className="text-3xl lightPurpleText font-bold mt-8 mb-4 text-left">Enforcement</h2>
        <p className="textFont mb-4 text-left">
          Violations of the Code of Conduct may be reported by sending an email to <strong>incidents@cusec.net</strong>. All reports will be reviewed and investigated, resulting in responses deemed appropriate. We reserve the right to remove comments or contributions not aligned with this Code of Conduct.
        </p>
        <p className="textFont mb-4 text-left">
        ...
        <h2 className="text-3xl lightPurpleText font-bold mt-8 mb-4 text-left">Contact Information</h2>
        <p className="textFont mb-4 text-left">
          Email Address: <strong>incidents@cusec.net</strong><br />
          Non-Emergency Local Law Enforcement (SPVM): +1-(514)-280-2222<br />
          Emergency: 911
        </p>
      </div>
      );
