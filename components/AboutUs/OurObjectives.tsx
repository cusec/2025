...
export default function OurObjectives() {
  return (
    <div className="w-[85%] xl:w-[45%] max-w-[900px] h-auto mx-auto py-[25px] bg-[--purple] rounded-[20px] flex flex-col justify-center items-center gap-2">
      {/* head */}
      <div className="w-full flex flex-col md:flex-row flex-wrap justify-center items-center gap-2">
        <h3 className="text-white text-[40px] md:text-6xl font-bold BScreensText">
          OUR OBJECTIVES
        </h3>
      </div>
