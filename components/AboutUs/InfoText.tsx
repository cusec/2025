...
export default function InfoText() {
  return (
    <div className="w-[85%] lg:w-[45%] max-w-[900px] h-auto mx-auto pb-[25px] flex flex-col justify-center items-center gap-2 text-center lg:text-left">
      <h1 className="purpleText text-5xl md:text-7xl font-extrabold lg:hidden">
        WHAT IS CUSEC?
      </h1>
      <p className="RobotoText text-[--dark-blue] text-sm md:text-4xl font-light tracking-normal">
