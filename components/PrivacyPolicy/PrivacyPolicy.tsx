    ...
    <div className="w-full flex justify-center">
      <div className="content-container w-11/12 sm:w-8/12 md:w-9/12 lg:w-4/5 p-8 rounded-lg mt-10">
        ...
        <p className="textFont mb-4 text-left">
          Your privacy is important to us. It is CUSEC's policy to respect your privacy regarding any information we may collect from you across our website, 
          <a href="https://2024.cusec.net" className="hover:underline"> https://2024.cusec.net</a>, and other sites we own and operate.
        </p>
